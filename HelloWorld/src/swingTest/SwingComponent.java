...
public class SwingComponent
{
    ...
    // 定义一个按钮,并为之指定图标
    Icon okIcon = new ImageIcon("./src/swingTest/ico/ok.png");
    ...
    // 创建“新建”菜单项，并为之指定图标
    Icon newIcon = new ImageIcon("./src/swingTest/ico/new.png");
    JMenuItem newItem = new JMenuItem("新建" , newIcon);
    // 创建“保存”菜单项，并为之指定图标
    Icon saveIcon = new ImageIcon("./src/swingTest/ico/save.png");
    JMenuItem saveItem = new JMenuItem("保存" , saveIcon);
    // 创建“退出”菜单项，并为之指定图标
    Icon exitIcon = new ImageIcon("./src/swingTest/ico/exit.png");
    JMenuItem exitItem = new JMenuItem("退出" , exitIcon);
    JCheckBoxMenuItem autoWrap = new JCheckBoxMenuItem("自动换行");
    // 创建“复制”菜单项，并为之指定图标
    JMenuItem copyItem = new JMenuItem("复制"
            , new ImageIcon("./src/swingTest/ico/copy.png"));
    // 创建“粘贴”菜单项，并为之指定图标
    JMenuItem pasteItem = new JMenuItem("粘贴"
            , new ImageIcon("./src/swingTest/ico/paste.png"));
